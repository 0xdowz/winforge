...
class SessionManager:
    ...
    def __init__(self, session_id: Optional[str] = None):
        ...
        self.sessions_root: Path = get_sessions_dir()
    ...
    def save_session_summary(self, summary: Dict[str, Any]) -> Path:
        """Serialize human-readable session summary into session_summary.json."""
        target_path = self.session_dir / "session_summary.json"
        payload = {
            "session_id": self.session_id,
            "timestamp": datetime.now().isoformat(),
            **summary
